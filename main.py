...
task_option = ['Вариант №2', 'Вариант №3', 'Вариант №7', 'Вариант №9', 'Вариант №12', 'Вариант №16']

choice_task_option = st.selectbox('**Выберите вариант задания команды №3:**', [''] + task_option)
